...
import PushStep from '@/components/setup/PushStep';
import IntegrationsStep from '@/components/setup/IntegrationsStep';
  ...
  return (
    <main className="flex min-h-screen items-center justify-center px-6 py-12">
      <div className="glass w-full max-w-xl space-y-8 p-8">
        ...
        {step === 4 && <PushStep onNext={goNext} onBack={goBack} />}
        {step === 5 && <IntegrationsStep onNext={goNext} onBack={goBack} />}
        {step === 6 && <SelfcareStep onNext={goNext} onBack={goBack} />}
        {step === 7 && <ReviewStep identity={identity} onBack={goBack} />}
      </div>
    </main>
  );
}
