...
const FLOWS: FlowPath[] = [
  {
    ...
    edges: [
      ...
      { from: 'stt', to: 'orchestrator', label: 'Text' },
      { from: 'orchestrator', to: 'router', label: 'Classify' },
      { from: 'router', to: 'helios', label: 'Baseline mode' },
      { from: 'helios', to: 'nemotron', label: 'ask_orchestrator' },
      { from: 'nemotron', to: 'ha', label: 'home_assistant' },
      { from: 'nemotron', to: 'helios', label: 'Result' },
      { from: 'helios', to: 'tts', label: '"Done! Bedroom is blue"' },
