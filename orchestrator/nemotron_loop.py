...
import shared
from shared import NEMOTRON_URL, NEMOTRON_MODEL, MAX_TOOL_ROUNDS
from prompt_builder import get_nemotron_system_prompt, get_orchestrator_system_prompt
...
TERMINAL_TOOLS = {
    "start_focus", "stop_focus", "set_reminder", "cancel_reminder",
